...
function select_Freminet() {
  if (count_Freminet == false) {
    document.querySelector(".char .Freminet .box").style.cssText = Borders
    count_Freminet = true;
    Character[Character.length] = "Freminet";
    if (Character.length == CharCheck.length) {
      document.querySelector(".selectall_char").style.cssText = "display: none;"
      document.querySelector(".unselectall_char").style.cssText = "display: ;"
    }
  ...
  if (count_Freminet == true) {
    document.querySelector(".char .Freminet .box").style.border = "";
    count_Freminet = false;
    let index = Character.indexOf("Freminet");
    Character.splice(index, 1);
    if (Character.length == CharCheck.length) {
      document.querySelector(".selectall_char").style.cssText = "display: none;"
      document.querySelector(".unselectall_char").style.cssText = "display: ;"
...
function select_Lynette() {
  if (count_Lynette == false) {
    document.querySelector(".char .Lynette .box").style.cssText = Borders
    count_Lynette = true;
    Character[Character.length] = "Lynette";
    if (Character.length == CharCheck.length) {
      document.querySelector(".selectall_char").style.cssText = "display: none;"
      document.querySelector(".unselectall_char").style.cssText = "display: ;"
    }
  ...
  if (count_Lynette == true) {
    document.querySelector(".char .Lynette .box").style.border = "";
    count_Lynette = false;
    let index = Character.indexOf("Lynette");
    Character.splice(index, 1);
    if (Character.length == CharCheck.length) {
      document.querySelector(".selectall_char").style.cssText = "display: none;"
      document.querySelector(".unselectall_char").style.cssText = "display: ;"
...
function select_Lyney() {
  if (count_Lyney == false) {
    document.querySelector(".char .Lyney .box").style.cssText = Borders
    count_Lyney = true;
    Character[Character.length] = "Lyney";
    if (Character.length == CharCheck.length) {
      document.querySelector(".selectall_char").style.cssText = "display: none;"
      document.querySelector(".unselectall_char").style.cssText = "display: ;"
    }
  ...
  if (count_Lyney == true) {
    document.querySelector(".char .Lyney .box").style.border = "";
    count_Lyney = false;
    let index = Character.indexOf("Lyney");
    Character.splice(index, 1);
    if (Character.length == CharCheck.length) {
      document.querySelector(".selectall_char").style.cssText = "display: none;"
      document.querySelector(".unselectall_char").style.cssText = "display: ;"
